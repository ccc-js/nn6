...
class Tanh extends Gate {
  constructor(inputs, out) { super(inputs, out, D.tanh, D.dtanh) }
}

class Exp extends Gate {
  constructor(inputs, out) {
    super(inputs, out, D.exp, D.dexp)
  }
}
...
class Pow extends Gate {
  constructor(inputs, out) {
    super(inputs, out, D.pow, D.dpow, D.dpowy)
  }
}
...
class Softmax extends Gate {
  forward () {
    return D.softmax(this.inputs)
  }
}
